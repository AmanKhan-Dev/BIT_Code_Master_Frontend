...
export const api = axios.create({
    baseURL: "http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/api/quizzes" // Ensure this is the correct base URL for quiz APIs
});

export const api1 = axios.create({
    baseURL: "http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/codingQuestions" // Ensure this is the correct base URL for coding questions
});
