...
export const api = axios.create({
    baseURL: "http://10.128.0.2:8080/api/quizzes" // Ensure this is the correct base URL for quiz APIs
});

export const api1 = axios.create({
    baseURL: "http://10.128.0.2:8080/codingQuestions" // Ensure this is the correct base URL for coding questions
});
