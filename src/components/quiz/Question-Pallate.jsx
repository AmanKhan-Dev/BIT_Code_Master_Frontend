...
const Pallate = () => {
  ...
  useEffect(() => {
    const fetchSetInfo = async () => {
      try {
        const response = await axios.get(`https://bit-code-master-backend-879855cbe9fa.herokuapp.com/sets/${questionSetId}`); // Fetch set information
    ...
    const fetchQuestions = async () => {
      try {
        const response = await axios.get('https://bit-code-master-backend-879855cbe9fa.herokuapp.com/codingQuestions/questionsBySetId', {
  ...
  const checkSolvedQuestions = async (questions) => {
    ...
    for (const question of questions) {
      try {
        const response = await axios.get('https://bit-code-master-backend-879855cbe9fa.herokuapp.com/api/results/exists', {
          params: {
