...
const Pallate = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axios.get('https://measuring-advanced-yoga-cooking.trycloudflare.com/codingQuestions/questionsBySetId', {
  ...
  const checkSolvedQuestions = async (questions) => {
    ...
    for (const question of questions) {
      try {
        const response = await axios.get('https://measuring-advanced-yoga-cooking.trycloudflare.com/api/results/exists', {
          params: {
