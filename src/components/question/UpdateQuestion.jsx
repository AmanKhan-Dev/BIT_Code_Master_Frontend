...
const UpdateQuestion = () => {
	...
	const handleAddCategory = async () => {
		...
		try {
			...
			const response = await axios.post("http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/api/categories/add", categoryData);
	...
	const addTestCases = async (questionId) => {
		...
		try {
			await axios.post("http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/api/testcases/add", testCasesToAdd);
		} catch (error) {
