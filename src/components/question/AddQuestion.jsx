...
const AddQuestion = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      const response = await axios.get(`http://34.123.112.154:8080/api/categories/set/${questionSetId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        await axios.post("http://34.123.112.154:8080/codingQuestions/add", questionAdder);
...
const addTestCases = async (questionId) => {
    ...
    try {
        ...
        await axios.post("http://34.123.112.154:8080/api/testcases/add", testCasesToAdd);
  ...
  const handleAddCategory = async () => {
    ...
    try {
        ...
        const response = await axios.post("http://34.123.112.154:8080/api/categories/add", categoryData);
