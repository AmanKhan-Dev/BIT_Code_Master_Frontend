...
const AddQuestion = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      const response = await axios.get(`https://measuring-advanced-yoga-cooking.trycloudflare.com/api/categories/set/${questionSetId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        await axios.post("https://measuring-advanced-yoga-cooking.trycloudflare.com/codingQuestions/add", questionAdder);
