...
const AddQuestion = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      const response = await axios.get(
        `http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/api/categories/set/${questionSetId}`,
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const questionAdder = {
        ...
        question_category:
          questionCategory === "New" ? newCategory : questionCategory, // Use new category if selected
      };
      ...
      await axios.post(
        "http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/codingQuestions/add",
        questionAdder,
      );
  ...
  const addTestCases = async (questionId) => {
    ...
    try {
      ...
      await axios.post(
        "http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/api/testcases/add",
        testCasesToAdd,
      );
      ...
      alert(
        "Error adding test cases. Please check the console for more details.",
      );
    }
  };
  ...
  const handleAddCategory = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/api/categories/add",
        categoryData,
      );
  ...
  const handleRunCode = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://myspringapp-env.eba-guzhenp3.us-east-1.elasticbeanstalk.com/api/compiler/compile",
        {
          sourceCode,
    ...
    <div className="add-question-container">
      ...
      <div className="form-section">
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            <label htmlFor="questionNumber" className="form-label">
              Question Number
            </label>
            <input
              type="text"
          ...
          {questionCategory === "New" && (
            <div className="mb-3">
              ...
              {categoryMessage && (
                <div className="text-success mt-1">{categoryMessage}</div>
              )}
            </div>
          )}
