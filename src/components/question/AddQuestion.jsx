...
const AddQuestion = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      const response = await axios.get(`http://35.226.248.183:8080/api/categories/set/${questionSetId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        await axios.post("http://35.226.248.183:8080/codingQuestions/add", questionAdder);
